...
![texLab main panel — open the Library tab from the toolbar](/assets/manual-mode.png)
...
![texLab main panel — open the Semantics tab from the toolbar](/assets/manual-mode.png)
...
![texLab main panel — open the Builder tab from the toolbar](/assets/manual-mode.png)
...
![texLab main panel — open the Settings tab from the toolbar](/assets/manual-mode.png)
